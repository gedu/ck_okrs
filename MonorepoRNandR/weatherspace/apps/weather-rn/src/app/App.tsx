...
// @ts-ignore: Find a way to include the store into the tsconfig
import { getStoreName } from '@weatherspace/store';
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore: Find a way to include the store into the tsconfig
import { ActivityIndicator } from '@weatherspace/ui-components';
      ...
      <SafeAreaView>
        ...
        >
          <View style={styles.section}>
            <Text style={styles.textLg}>Hello there, {getStoreName()}</Text>
